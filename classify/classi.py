...
def main(video_path):
    ...
    json_file = open('project-RG/models/convautoencodermodel_10.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    loaded_model.load_weights('project-RG/models/convautoencodermodel_10.h5')
    
    # 用视频训练KMeans
    print("[INFO] 用demo.mp4训练KMeans队伍识别...")
    train_video = "demo.mp4"
    ...
    start_frame = int(39 * original_fps)
